...
/**
* Another sample paginator
*
* Illustrates the use of the tina_mvc_pagination_helper_class with custom html
* rows.
*
* @package    Tina-MVC
* @subpackage Tina-Sample-Apps
* @author     Francis Crossen <francis@crossen.org>
*/
class sample_pagination_2_page extends tina_mvc_base_page_class {
    ...
    function index() {
         ...
         */
        $P->set_base_url( tina_mvc_make_controller_url('sample-pagination-2') );
        ...
        foreach( $rows AS $i => & $r ) {
            ...
            $new_row = '';
            $new_row .= "<div style=\"border: thin solid #888; color: $fg; background: $bg\">\r\n";
            $new_row .= "<small><em>This is row number ".strval($i)."</em></small><br />\r\n";
            $new_row .= "<strong><big>Display Name: ".$r->{'Display Name'}."</big></strong><br />\r\n";
            $new_row .= "User Login: ".$r->{'User Login'}." (Database ID: ".$r->{'Database ID'}.")\r\n";
            $new_row .= "</div>\r\n";
