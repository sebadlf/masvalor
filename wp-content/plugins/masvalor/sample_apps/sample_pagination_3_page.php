...
*
* Another illustration of the use of the tina_mvc_pagination_helper_class with custom html
* rows.
*
* @package    Tina-MVC
* @subpackage Tina-Sample-Apps
* @author     Francis Crossen <francis@crossen.org>
*/
class sample_pagination_3_page extends tina_mvc_base_page_class {
    ...
    function index() {
         ...
         */
        $P->set_base_url( tina_mvc_make_controller_url('sample-pagination-3') );
