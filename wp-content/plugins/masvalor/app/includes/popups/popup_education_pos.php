	...
	if (validateFields()){
		if(parent.validate_dates(document.getElementById("from_date").value,document.getElementById("to_date").value)) {
			if(confirm("\u00BFEst\u00e1 seguro que quiere guardar la educaci\u00f3n?")) {
			  ...
			  if ( parent.addEducationPos(title,university,fromDate,toDate,universityid,stateValue,type_title))
			...
			<tr >
				<td valign="top">
					<fieldset class="adminform" style="background-color: #E3E3E3;font-family:Verdana,arial,helvetica;">
						<legend>Educaci&oacute;n de Postgrado</legend>
						<table class="admintable" >
							
							<tr>
								<td class="key" style="font-size:11px;">T&iacute;tulo Profesional (*)</td>
							...
							<tr>
								<td class="key" style="font-size:11px;">Tipo (*)</td>
								<td>
