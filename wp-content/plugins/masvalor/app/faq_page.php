<?php
require_once ('models/faq_model.php');
class faq_page extends tina_mvc_base_page_class {
    ...
    function __construct( $request=array() ) {
        ...
        $this->faq( $request,$msg);
    }
	 	 
    function faq( $request,$msg) {
        global $current_user;
		get_currentuserinfo();
		...
		if (!checkUserType($current_user->user_login,'masvalor-admin'))
			...
			$this->set_post_title(__('Agregar/Editar FAQS'));
			$this->set_post_content( $this->load_view('faq', $tpl_vars ) );
		}
