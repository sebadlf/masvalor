...
function saveDelete(cid){
    if(confirm("¿Est\u00e1 seguro que quiere borrar la cuidad?")) { 
			...
			<tr>
				 ...
				 <legend><h2><?php echo __('Ciudades') ?></h2></legend>
					...
					<div style="float: right; margin-top: -22px;">
						<a href="<?php echo masvalor_getUrl(); ?>/city/"> <img src="wp-content/plugins/masvalor/app/includes/image/nuevo.png"></a> 
					</div>
						...
						<hr/>
							...
							<?php  foreach ($V->datas as $data){ ?>
										<tr style="background-color: #e3e3e3">
											...
											<td><a href="<?php echo masvalor_getUrl(); ?>/city/&cid=<?php echo $data->id;?>">
