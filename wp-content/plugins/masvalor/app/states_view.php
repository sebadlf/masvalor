...
function saveDelete(cid){
    if(confirm("¿Est\u00e1 seguro que quiere borrar la provincia?")) { 
...
a{
 ...
 color:black;
		...
		<div id="table_noticia" style="font-size: 14px;margin-top: 20px;">
			...
			<tr>
				 <td>
				 <legend><h2><?php echo __('Provincias') ?></h2></legend>
				 				
					
					<div style="float: right; margin-top: -22px;">
						<a href="<?php echo masvalor_getUrl(); ?>/state/"> <img src="wp-content/plugins/masvalor/app/includes/image/nuevo.png"></a> 
					</div>
						...
						<hr/>
							...
							<?php  foreach ($V->datas as $data){ ?>
										<tr style="background-color: #e3e3e3">
											...
											<td><a href="<?php echo masvalor_getUrl(); ?>/state/&cid=<?php echo $data->id;?>">
