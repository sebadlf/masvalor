...
<script type="text/javascript" src="dhtmlxcommon.compressed.js"></script>
...
//	document.getElementById('event_dsc').focus();
	...
	if (hourValueEnd.length < 2) {
		hourValueEnd = '0' + hourValueEnd;
	}
	if (minValueEnd.length < 2) {
		minValueEnd = '0' + minValueEnd;
	}
...
function makeDate(date, h, m) {
	...
	var month = date[1];
	var day = date[2];
	dateObj = new Date(year, month, day, h, m, '00')
...
//	var dsc = document.getElementById('event_dsc').value;
